...
2. Place feature-specific documentation in the `docs/features` directory.
3. Place database-related documentation in the appropriate database directory (e.g., `docs/timescaledb`).
